...
app.post("/upload", uploadDetail.single("userfile"), (req, res) => {
  ...
  //     filename: '7399f417e8d2f61ec9456409d570eacf', // destination 저장된 파일명
  //     path: 'uploads/7399f417e8d2f61ec9456409d570eacf', // 업로드된 파일 전체 경로
  //     size: 2515 // 파일 크기
  //   }
});
...
app.post(
  ...
  (req, res) => {
    console.log(req.files); // { userfile1:[ {파일_정보} ], userfile2: [ {파일_정보} ]} 객체 안에 배열 형태로 각 파일 정보 출력
    console.log(req.body);
    res.send("하나의 인풋에 여러 파일 업로드 완료!");
  }
);
